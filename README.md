...
> **[Open the results dashboard →](https://manideep-ram-gunje.github.io/aegis-pharmacovigilance/docs/dashboard/AEGIS-dashboard.html)**
...
```bash
git clone https://github.com/Manideep-Ram-Gunje/aegis-pharmacovigilance.git
cd aegis-pharmacovigilance
pip install pymysql
...
| Area | Owner |
|---|---|
| Data engineering, SQL warehouse, signal engine, BI layer | Manideep Ram Gunje |
